    ...
    return (
        <section className="fixed inset-0 z-9999 flex items-center justify-center bg-black px-4">
            <div className={[
                ...
                "text-center shadow-[0_8px_30px_rgba(0,0,0,0.35)] backdrop-blur-xl",
            ].join(" ")}>
                <div className={[
                    "mx-auto flex h-14 w-14 items-center justify-center rounded-full border",
                    "border-[#ff453a]/20 bg-[#ff453a]/10",
                ].join(" ")}>
                ...
                <div className="mt-8 flex flex-col gap-3">
                    <button
                        ...
                        className={[
                            ...
                            "to-indigo-600 text-[14px] font-medium text-white shadow-md",
                    ...
                    <Link
                        href="/"
                        className={[
                            "flex h-11 cursor-pointer items-center justify-center rounded-full border",
                            "border-white/[0.06] bg-white/5 text-[14px] font-medium text-white",
