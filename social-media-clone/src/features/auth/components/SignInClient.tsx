...
export default function SignInClient() {
  ...
  return (
    <main className="flex min-h-[80vh] flex-col items-center justify-center bg-black px-4 lg:min-h-[90vh]">
      <section
        className={[
      ...
      >
        ...
        <button
          ...
          className={[
            ...
            "rounded-full border border-white/[0.06] bg-white/5 text-[14px] font-medium",
        ...
        {authError && (
          <p role="alert" className="mt-4 text-center text-[13px] text-red-300">
            Google sign-in could not be completed. Please try again.
          </p>
        )}

        <p className="mt-6 text-center text-[12px] leading-5 text-zinc-600">
          Quietly uses Google only to sign you in.
        </p>
      </section>
    </main>
  );
