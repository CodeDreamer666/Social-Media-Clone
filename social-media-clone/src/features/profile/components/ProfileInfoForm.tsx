    ...
    return (
        ...
        >
            ...
            <div className="mb-6">
                ...
                <input
                    ...
                    className={[
                        ...
                        "px-4 py-3 text-[14px] leading-7 text-white outline-none transition-colors",
                ...
                <div className="mt-4">
                    <div className="mb-3">
                        ...
                        <p className="mt-1 text-[12px] leading-5 text-zinc-500">
                            Private accounts only share posts, comments, and commenting with connections.
                        </p>
                    </div>
                    ...
                    <div className="relative grid grid-cols-2 gap-2 rounded-2xl border border-white/[0.06] bg-black/40 p-1">
                        ...
                        <button
                            ...
                            className={[
                                "relative cursor-pointer z-10 rounded-xl px-3 py-3 text-[13px] font-medium",
                                "transition-colors duration-200",
                                !isPublic
                                    ? "text-blue-100"
                                    : "text-zinc-400 hover:bg-white/[0.04] hover:text-white",
            ...
            <div className="flex justify-end">
                <button
                    disabled={isPending || username.length === 0 || bio.length === 0}
                    onClick={onSave}
                    className={[
