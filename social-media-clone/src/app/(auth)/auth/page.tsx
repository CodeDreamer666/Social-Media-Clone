        ...
        <Suspense fallback={null}>
            <section className="flex min-h-[75vh] flex-col items-center justify-center">
                <section className="w-[95%] max-w-md rounded-3xl border border-neutral-800 bg-neutral-900 p-8  shadow-2xl shadow-black/20">
                    <div className="mb-8 flex items-start gap-4 max-xs:flex-col">
                        <div className="flex items-center gap-4">
                            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border border-neutral-800 bg-neutral-950">
                                <svg
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-sm leading-6 text-neutral-400 max-xs:pl-0">
